...
def write_arxiv_paper(paper: dict[str, Any], settings: Settings) -> str:
    ...
    folder = settings.obsidian_subfolder("Papers") / date_str
...
def write_marketplace_summary(
    ...
    *,
    ...
    date_str = datetime.now(UTC).strftime("%Y-%m-%d")
    folder = settings.obsidian_subfolder("FB-Marketplace") / date_str
    folder.mkdir(parents=True, exist_ok=True)
...
def write_youtube_summary(videos: list[dict[str, Any]], settings: Settings) -> str:
    ...
    date_str = datetime.now(UTC).strftime("%Y-%m-%d")
    folder = settings.obsidian_subfolder("YouTube") / date_str
    folder.mkdir(parents=True, exist_ok=True)
...
def write_idea_note(
    ...
    date_str = datetime.now(UTC).strftime("%Y-%m-%d")
    folder = settings.obsidian_subfolder("Ideas") / date_str
    folder.mkdir(parents=True, exist_ok=True)
